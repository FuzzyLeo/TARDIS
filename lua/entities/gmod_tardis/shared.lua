...
---@overload fun(self: gmod_tardis, name: "CanPlayerEnterDoor", id: string, func: fun(self: gmod_tardis, a: any, ...))
...
---@overload fun(self: gmod_tardis, name: "CanUsePart", id: string, func: fun(self: gmod_tardis, arg1: gmod_tardis_part, a: any, ...))
...
---@overload fun(self: gmod_tardis, name: "LanguageChanged", id: string, func: fun(self: gmod_tardis, langCode: any, oldLangCode: any, ...))
...
---@overload fun(self: gmod_tardis, name: "PartUsed", id: string, func: fun(self: gmod_tardis, arg1: gmod_tardis_part, a: any, ...))
...
---@overload fun(self: gmod_tardis, name: "ShouldDrawBlackScreen", id: string, func: fun(self: gmod_tardis, arg1: any, ...))
...
---@overload fun(self: gmod_tardis, name: "ShouldNotDrawScreen", id: string, func: fun(self: gmod_tardis, arg1: any, ...))
...
---@overload fun(self: gmod_tardis, name: "ShouldNotRenderPortal", id: string, func: fun(self: gmod_tardis, arg1: gmod_tardis_interior, portal: any, exit: any, origin: any, ...))
...
---@overload fun(self: gmod_tardis, name: "SpinChanged", id: string, func: fun(self: gmod_tardis, arg1: any, ...))
