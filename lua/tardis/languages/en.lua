...
T.Phrases = {
    ...
    ["Settings.Sections.GUI.Chameleon3DPreview"] = "Chameleon Circuit 3D Preview (experimental)",
    ["Settings.Sections.GUI.Chameleon3DPreview.Description"] = "Enable 3D movable preview of the selected exterior in the chameleon circuit GUI",
    ...
    ["Settings.Sections.GUI.PopupScale"] = "GUI popup scale",
    ["Settings.Sections.GUI.PopupScale.Description"] = "Allows to scale the popup for new visual GUI",
    ...
    ["Settings.Sections.Misc.ShowReleaseNotes"] = "Show release notes",
    ["Settings.Sections.Misc.ShowReleaseNotes.Description"] = "Should release notes be shown when the TARDIS is updated?",
    ...
    ["Settings.Sections.Misc.Spawning.UseEnhancedDoorCollision"] = "Use enhanced door collision (experimental)",
    ["Settings.Sections.Misc.Spawning.UseEnhancedDoorCollision.Description"] = "TARDIS doors will have collision with all entities when closed, not just players",
    ...
    ["Settings.Sections.Misc.SpawnmenuInteriorIcons"] = "Always show interiors in spawnmenu",
    ["Settings.Sections.Misc.SpawnmenuInteriorIcons.Description"] = "Should spawnmenu's icons always show interiors?",
    ...
    ["Settings.Sections.Misc.Tips.ShowAll"] = "Always show all tips",
    ["Settings.Sections.Misc.Tips.ShowAll.Description"] = "Should all tips be shown for TARDIS controls?",
