...
T.Phrases = {
    ...
    ["ArtronInhibitor"] = "雅昌抑制器",
    ["ArtronInhibitor.Disabled"] = "雅昌抑制器已禁用",
    ["ArtronInhibitor.Enabled"] = "雅昌抑制器已啟用",
    ["ArtronInhibitor.Instructions"] = "創建一個雅昌抑制場，會從附近的塔迪斯中抽取雅昌能量",
    ["ArtronInhibitor.Starting"] = "正在啟動雅昌抑制器……",
    ["Binds.AnyKey"] = "按下任意鍵",
    ["Binds.Invalid"] = "無效",
    ["Binds.Key"] = "鍵",
    ...
    ["Binds.Sections.Destination.Chameleon"] = "切換變色龍電路",
    ["Binds.Sections.Destination.Chameleon.Description"] = "按下此鍵選擇變色龍電路預設",
    ["Binds.Sections.Destination.Down"] = "下",
    ["Binds.Sections.Destination.FindRandom"] = "尋找隨機目標",
    ["Binds.Sections.Destination.FindRandom.Description"] = "按下此鍵尋找一個隨機目標",
    ["Binds.Sections.Destination.Forward"] = "前",
    ["Binds.Sections.Destination.Jump"] = "跳至表面",
    ["Binds.Sections.Destination.Jump.Description"] = "按住此鍵選擇表面並移動至該處",
    ...
    ["Binds.Sections.Destination.ShowCurrent"] = "顯示當前目標",
    ["Binds.Sections.Destination.ShowCurrent.Description"] = "按下此鍵顯示當前設定的目標",
    ...
    ["Binds.Sections.Destination.ToggleRotationMode"] = "切換旋轉模式",
    ["Binds.Sections.Destination.ToggleRotationMode.Description"] = "按下此鍵切換旋轉模式",
    ...
    ["Binds.Sections.Flight.Tracking"] = "追蹤",
    ["Binds.Sections.Flight.Tracking.Description"] = "按住以選擇要追蹤/跟隨的實體",
    ["Binds.Sections.Flight.TrackRotation"] = "追蹤旋轉",
    ["Binds.Sections.Flight.TrackRotation.Description"] = "切換是否追蹤目標實體的旋轉",
    ...
    ["Binds.Sections.ThirdPerson.ToggleHandbrake"] = "切換手煞車",
    ...
    ["Chameleon.FailReasons.AlreadyChanging"] = "外觀已經在改變！",
    ["Chameleon.FailReasons.AlreadySelected"] = "此外觀已被選中",
    ["Chameleon.FailReasons.DoorsOpen"] = "等待關門...",
    ["Chameleon.FailReasons.NoPower"] = "變色龍電路在沒有電源的情況下不工作",
    ["Chameleon.FailReasons.NotEnoughArtron"] = "沒有足夠的 artron 能量來切換變色龍電路",
    ["Chameleon.FailReasons.SameSelected"] = "TARDIS 已經有了這個外觀",
    ["Chameleon.FailReasons.Teleporting"] = "TARDIS 著陸時外觀會發生變化",
    ["Chameleon.Status"] = "變色龍電路",
    ["Chameleon.Status.Activated"] = "活性",
    ["Chameleon.Status.Deactivated"] = "停用",
    ["Common.AddToFavourites"] = "添加到收藏夾",
    ["Common.Automatic"] = "自動",
    ["Common.Cancel"] = "取消",
    ["Common.Closed"] = "已關閉",
    ...
    ["Common.Remove"] = "移除",
    ["Common.RemoveFromFavourites"] = "從收藏夾中移除",
    ["Common.Reset"] = "復位",
    ["Common.Save"] = "保存",
    ["Common.Set"] = "設定",
    ["Common.TARDIS"] = "塔迪斯",
    ...
    ["Controls.EngineRelease.ArtronAdded"] = "已犧牲健康以在漩渦中充能 artron 能量",
    ["Controls.EngineRelease.FailedDemat"] = "起飛失敗",
    ["Controls.EngineRelease.ForceDemat"] = "強製起飛已觸發",
    ["Controls.EngineRelease.Tip"] = "引擎製動",
    ["Controls.ExteriorLight"] = "外部燈",
    ["Controls.ExteriorLight.Status"] = "外部燈",
    ["Controls.ExteriorLight.Tip"] = "外部燈",
    ...
    ["Controls.FlightlessFlight"] = "無飛之飛",
    ["Controls.FlightlessFlight.FailedToggle"] = "無法切換無飛行模式",
    ["Controls.FlightlessFlight.Status"] = "無翼之飛",
    ["Controls.FlightlessFlight.Tip"] = "無翼之飛",
    ["Controls.Float"] = "反重力",
    ...
    ["Controls.Power.FailedToggle.Interrupted"] = "切換電源失敗，中斷了 %s 秒",
    ["Controls.Power.FailedToggle.NoArtron"] = "切換電源失敗，亞創能量已耗盡",
    ["Controls.Power.FailedToggle.NoHealth"] = "切換電源失敗，生命值已耗盡",
    ["Controls.Power.FailedToggle.Repairing"] = "無法切換電源，TARDIS 正在自我修復模式",
    ["Controls.Power.FailedToggle.Travelling"] = "切換電源失敗，TARDIS 正在旅行",
    ...
    ["Controls.Shields"] = "護盾",
    ["Controls.Shields.FailedToggle"] = "切換護盾失敗",
    ["Controls.Shields.Status"] = "護盾",
    ...
    ["Controls.ToggleConsole"] = "切換控制台",
    ["Controls.ToggleConsole.Status"] = "安慰",
    ["Controls.ToggleConsole.Tip"] = "切換主控台",
    ["Controls.ToggleHandbrakeControl"] = "切換手剎控制",
    ["Controls.ToggleHandbrakeControl.Tip"] = "切換手煞車",
    ["Controls.ToggleScanners"] = "切換掃描儀",
    ["Controls.ToggleScanners.FailedToggle"] = "無法切換內部掃描儀",
    ["Controls.ToggleScanners.Status"] = "室內掃描儀",
    ["Controls.ToggleScanners.Tip"] = "切換掃描儀",
    ...
    ["Controls.ToggleTeleportControl"] = "切換傳送控制",
    ["Controls.ToggleTeleportControl.Tip"] = "切換油門",
    ["Controls.Tracking"] = "追蹤",
    ["Controls.Tracking.ConstrainedFail"] = "無法追蹤與本塔迪斯綁定的實體",
    ["Controls.Tracking.DistanceFail"] = "無法追蹤過遠的實體",
    ["Controls.Tracking.FlightFail"] = "啟用追蹤時無法啟用飛行模式",
    ["Controls.Tracking.GenericFail"] = "追蹤實體失敗",
    ["Controls.Tracking.InteriorFail"] = "無法追蹤在塔迪斯內部的實體",
    ["Controls.Tracking.PhyslockFail"] = "啟用物理鎖定時無法啟用追蹤",
    ["Controls.Tracking.PilotWarning"] = "警告：追蹤已啟用，按下 '%s' 更換目標或停用追蹤",
    ["Controls.Tracking.Rotation"] = "追蹤旋轉",
    ["Controls.Tracking.RotationChangedAuto"] = "根據目標旋轉自動追蹤旋轉 %s",
    ["Controls.Tracking.RotationHint"] = "按 '%s' 切換是否追蹤目標旋轉",
    ["Controls.Tracking.SameTarget"] = "你已經在追蹤此實體",
    ["Controls.Tracking.SelfFail"] = "塔迪斯無法追蹤自身",
    ["Controls.Tracking.SpinWarning"] = "警告：啟用自旋時無法更改追蹤方向",
    ["Controls.Tracking.Status"] = "追蹤",
    ["Controls.Tracking.Target"] = "開始追蹤 %s",
    ["Controls.Tracking.TargetLost"] = "追蹤目標丟失",
    ["Controls.Tracking.TargetTooFar"] = "追蹤目標過遠",
    ...
    ["CustomControls.Default.ToggleScreen.1"] = "切換螢幕1",
    ["CustomControls.Default.ToggleScreen.1.FailedToggle"] = "切換螢幕1失敗",
    ["CustomControls.Default.ToggleScreen.1.Status"] = "螢幕1",
    ["CustomControls.Default.ToggleScreen.1.Tip"] = "螢幕1",
    ["CustomControls.Default.ToggleScreen.2"] = "切換螢幕2",
    ["CustomControls.Default.ToggleScreen.2.FailedToggle"] = "切換螢幕2失敗",
    ["CustomControls.Default.ToggleScreen.2.Status"] = "螢幕2",
    ["CustomControls.Default.ToggleScreen.2.Tip"] = "螢幕2",
    ...
    ["Destination.RotationMode"] = "旋轉模式",
    ["Events.ConfirmDisable"] = "您確定要完全停用目前及所有未來的事件，還是只跳過目前的事件？",
    ["Events.ConfirmDisable.All"] = "停用所有事件",
    ["Events.ConfirmDisable.Current"] = "跳過目前事件",
    ["Events.Event"] = "事件",
    ["Events.NotifyEvent"] = "%s 有一個事件正在進行，請前往 TARDIS -> %s 設定以跳過或更改。",
    ["Events.SkipFailed"] = "無法跳過事件：%s",
    ["Events.SkipFailed.AlreadySkipped"] = "今年的 %s 活動已經被跳過",
    ["Events.SkipFailed.Disabled"] = "事件已停用",
    ["Events.SkipFailed.NoEvent"] = "目前沒有正在進行的活動",
    ["Events.SkipFailed.NotAutomatic"] = "目前的事件是手動設定的。",
    ["Events.Skipped"] = "已跳過今年的 %s 活動",
    ["Events.Types.AprilFools"] = "愚人節",
    ["Events.Types.AprilFools.NotifyEvent"] = "愚人節快樂！",
    ["Events.Types.Christmas"] = "聖誕節",
    ["Events.Types.Christmas.Lights.Animated"] = "動畫",
    ["Events.Types.Christmas.Lights.Changed"] = "聖誕燈飾狀態已變更為 %s",
    ["Events.Types.Christmas.Lights.Static"] = "靜態",
    ["Events.Types.Christmas.NotifyEvent"] = "聖誕快樂!",
    ["Events.Types.Halloween"] = "萬聖節",
    ["Events.Types.Halloween.NotifyEvent"] = "萬聖節快樂！",
    ["Expression2.Error"] = "不能在 TARDIS 以外的東西上調用 TARDIS 函數",
    ["Expression2.Security.UseDenied"] = "無法在同構安全激活的情況下在另一個 TARDIS 上調用 TARDIS 設置函數",
    ["Exteriors.Categories.Misc"] = "各種各樣的",
    ["Exteriors.Categories.PoliceBoxes"] = "派出所",
    ["Exteriors.Categories.TTCapsules"] = "TT膠囊",
    ["Exteriors.DefaultPoliceBox"] = "默認派出所",
    ["Exteriors.LegacyPoliceBox"] = "舊式警察崗亭",
    ["Exteriors.SIDRAT"] = "西德拉特",
    ["Exteriors.TTCapsuleType40"] = "TT 膠囊類型 40",
    ["Exteriors.TTCapsuleType50"] = "TT 膠囊類型 50",
    ["Exteriors.TTCapsuleType55"] = "TT 膠囊類型 55",
    ...
    ["IconPacks.Customize.HelpText"] = "安裝額外的圖示包以自訂 TARDIS 圖示。可以啟用或停用任意數量的圖示包，並向上或向下移動，以建立優先載入順序。\n\n選取圖示包時，會顯示該包中的所有圖示，若為優先圖示則會以綠色標示，若被優先序較高的其他圖示包覆蓋則會以紅色標示。\n\n每個分頁的圖示包設定都不同：生成圖示、內部和外部。內部會根據你的生成選單圖示模式設定顯示在生成選單中。\n\n如果未啟用 3D 預覽，外部圖示目前僅顯示在變色龍電路設定中。\n\n所選的缺失圖示會用於當所選圖示包中沒有可用圖示時，預設是一個空白方塊。",
    ["IconPacks.Customize.HowToUse"] = "如何使用",
    ["IconPacks.Customize.IconMode"] = "生成選單圖示模式",
    ["IconPacks.Customize.IconMode.InteriorOnHover"] = "滑鼠懸停時顯示內部",
    ["IconPacks.Customize.IconMode.InteriorOnly"] = "僅限室內",
    ["IconPacks.Customize.IconMode.SpawniconOnHover"] = "外觀在滑鼠懸停時",
    ["IconPacks.Customize.IconMode.SpawniconOnly"] = "僅限外部",
    ["IconPacks.Customize.MissingIcon"] = "遺失圖示",
    ["IconPacks.Customize.OpenWorkshop"] = "開啟 Steam 工作坊",
    ["IconPacks.Customize.PriorityHint"] = "列表中較高者優先",
    ["IconPacks.Customize.Reset"] = "重設為預設",
    ["IconPacks.Customize.Save"] = "儲存變更",
    ["IconPacks.Customize.Tab.Exterior"] = "外觀",
    ["IconPacks.Customize.Tab.Interior"] = "室內",
    ["IconPacks.Customize.Tab.Spawn"] = "生成圖示",
    ["IconPacks.Customize.Title"] = "自訂圖示",
    ["IconPacks.Customize.Undo"] = "復原",
    ["Interior.FindingPosition"] = "請稍候，正在為內部尋找合適的生成位置..",
    ["Interior.FindingPositionFailed.Generic"] = "查找位置時出現協程錯誤：%s",
    ["Interior.FindingPositionFailed.NoSpace"] = "警告：無法找到內部空間，您可以重試或使用其他地圖",
    ["Interior.FoundPosition"] = "完畢！",
    ["Interiors.Default"] = "預設",
    ["Interiors.Default.CustomSettings.ClassicDoorsButton"] = "啟用按鈕（經典門版本）",
    ["Interiors.Default.CustomSettings.Color"] = "內部顏色",
    ["Interiors.Default.CustomSettings.Color.Blue"] = "藍色",
    ["Interiors.Default.CustomSettings.Color.Dynamic"] = "動態（緩慢變化）",
    ["Interiors.Default.CustomSettings.Color.Green"] = "綠色",
    ["Interiors.Default.CustomSettings.Color.Random"] = "隨機",
    ["Interiors.Default.CustomSettings.Color.Turquoise"] = "青綠色",
    ["Interiors.Default.CustomSettings.ExteriorTextures"] = "外部紋理",
    ["Interiors.Default.CustomSettings.ExteriorTextures.Capaldi"] = "Capaldi",
    ["Interiors.Default.CustomSettings.ExteriorTextures.Original"] = "原始",
    ["Interiors.Default.CustomSettings.ExteriorTextures.Smith"] = "Smith",
    ["Interiors.Default.CustomSettings.Lamps"] = "燈光",
    ["Interiors.Default.CustomSettings.Lamps.Few"] = "少（最佳效能）",
    ["Interiors.Default.CustomSettings.Lamps.Many"] = "多（最佳視覺）",
    ["Interiors.Default.CustomSettings.Lamps.Off"] = "禁用",
    ["Interiors.Default.CustomSettings.ScreensOff"] = "生成時螢幕關閉",
    ["Interiors.Default.CustomSettings.SmallVersion"] = "小型內部（更少走廊）",
    ["Interiors.Default.CustomSettings.StudioSetCeiling"] = "攝影棚天花板",
    ["Interiors.Default.Versions.Capaldi"] = "Capaldi",
    ["Interiors.Default.Versions.Capaldi.ClassicDoors"] = "Capaldi (經典門版本) ",
    ["Interiors.Default.Versions.ClassicDoors"] = "Smith (經典門版本) ",
    ["Interiors.Default.Versions.SIDRAT"] = "西德拉外觀",
    ["Interiors.Default.Versions.TTCapsuleType40"] = "TT 膠囊型 40 外觀",
    ["Interiors.Default.Versions.TTCapsuleType50"] = "TT 膠囊型 50 外觀",
    ["Interiors.Default.Versions.TTCapsuleType55"] = "TT 膠囊型 55 外觀",
    ["Interiors.DefaultSIDRAT"] = "SIDRAT違約",
    ["Interiors.DefaultTTCapsuleType40"] = "TT 膠囊類型 40 默認",
    ["Interiors.DefaultTTCapsuleType50"] = "TT 膠囊類型 50 默認值",
    ["Interiors.DefaultTTCapsuleType55"] = "TT 膠囊類型 55 默認值",
    ...
    ["MenuOptions.SectionResetThisSection"] = "重置設定（本部分）",
    ["Music.LoadFailed"] = "錯誤：載入失敗（%s）",
    ["Music.LoadFailedBass"] = "錯誤：無法載入歌曲（錯誤 ID： %s, %s）",
    ["Music.Loading"] = "加載音樂中……",
    ["Music.Playing"] = "播放：%s",
    ["Music.Stopped"] = "停止播放",
    ...
    ["Parts.Moveable.UnfreezeHint"] = "提示：可以按下行走鍵 + 使用鍵來解除此物體的凍結狀態",
    ["Parts.Moveable.UnfreezeWithResetPositionOnUse"] = "物件已解凍，按下 WALK + USE 以重設",
    ["Prompts.LightingOverride"] = "此塔迪斯建議您啟用照明覆蓋，是否啟用？這可以稍後在塔迪斯設置中更改",
    ["Prompts.LOD"] = "塔迪斯內部可能需要高精細模型，現在更改？",
    ["Redecorate.Failed"] = "重裝修失敗：生成替代失敗",
    ["Screens.Chameleon"] = "變色龍電路",
    ["Screens.Chameleon.Apply"] = "申請",
    ["Screens.Chameleon.Categories"] = "類別",
    ["Screens.Chameleon.Exteriors"] = "外觀",
    ["Screens.Chameleon.Plan"] = "計劃",
    ...
    ["Screens.Coordinates.Copy"] = "複製",
    ["Screens.Coordinates.CurrentPosition"] = "當前位置：",
    ["Screens.Coordinates.Delete"] = "刪除",
    ["Screens.Coordinates.Destination"] = "目的地：",
    ["Screens.Coordinates.LocationsList"] = "地點",
    ...
    ["Screens.Coordinates.Save"] = "節省",
    ["Screens.Coordinates.Set"] = "放",
    ...
    ["Screens.Music.DefaultLoadError.InvalidJson"] = "無效的JSON格式",
    ...
    ["Settings.Sections.Exterior.Effects"] = "效果",
    ["Settings.Sections.Exterior.Effects.RotorwashEnabled"] = "啟用旋翼洗",
    ["Settings.Sections.Exterior.Effects.RotorwashEnabled.Description"] = "在飛行或傳送時是否應啟用 TARDIS 的旋翼洗效果？",
    ["Settings.Sections.Exterior.Effects.SmokeEnabled"] = "受損時啟用煙霧",
    ["Settings.Sections.Exterior.Effects.SmokeEnabled.Description"] = "當TARDIS外觀受損時，是否應啟用冒煙效果？",
    ["Settings.Sections.Exterior.Light"] = "外部照明",
    ["Settings.Sections.Exterior.Light.AlwaysOn"] = "默認情況下打開外部燈",
    ["Settings.Sections.Exterior.Light.AlwaysOn.Description"] = "除非通過控件禁用，否則外部燈是否應該始終點亮？",
    ["Settings.Sections.Exterior.Light.ColorOverride"] = "顏色覆蓋",
    ["Settings.Sections.Exterior.Light.ColorOverride.Description"] = "外部燈光的覆蓋顏色",
    ["Settings.Sections.Exterior.Light.DynamicLightSize"] = "動態光源尺寸",
    ["Settings.Sections.Exterior.Light.DynamicLightSize.Description"] = "動態外部燈的尺寸",
    ...
    ["Settings.Sections.Exterior.Rendering"] = "渲染",
    ["Settings.Sections.Exterior.Rendering.EnhancedFadingEnabled"] = "強化淡化",
    ["Settings.Sections.Exterior.Rendering.EnhancedFadingEnabled.Description"] = "修正當外部淡入或淡出時的渲染問題（背面剔除）",
    ["Settings.Sections.Global"] = "管理員選項",
    ["Settings.Sections.Global.AdminSecurityBypass"] = "管理員安全繞過",
    ["Settings.Sections.Global.AdminSecurityBypass.Description"] = "管理員是否應該能夠繞過同構安全性？",
    ["Settings.Sections.Global.ArtronEnergy"] = "雅昌能源",
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyChargeFrequency"] = "無手剎時的充電頻率（以秒為單位）",
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyChargeFrequency.Description"] = "在沒有手剎的情況下，雅昌能量的充電頻率是多少？",
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyEnabled"] = "啟用雅昌能源",
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyEnabled.Description"] = "TARDIS 是否應該有限量的 artron 能量（燃料）？",
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyMax"] = "最大雅昌能量",
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyMax.Description"] = "TARDIS 可以擁有的 artron 能量的最大值",
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyStart"] = "產卵時的雅昌能級",
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyStart.Description"] = "TARDIS 生成時的 artron 能量水平",
    ...
    ["Settings.Sections.Global.HealthToShieldsRatio"] = "生命值與護盾值之比",
    ["Settings.Sections.Global.HealthToShieldsRatio.Description"] = "更高的比率會帶來更多的生命值，但更少的護盾，總生命值/護盾保持不變",
    ["Settings.Sections.Global.MaxHealth"] = "最大生命值",
    ["Settings.Sections.Global.MaxHealth.Description"] = "塔迪斯的最大生命值",
    ["Settings.Sections.Global.WaitLongForRepair"] = "啟用長修復",
    ["Settings.Sections.Global.WaitLongForRepair.Description"] = "最大修復時間應該是 60 秒而不是 15 秒嗎？",
    ["Settings.Sections.Misc"] = "雜項",
    ["Settings.Sections.Misc.DoorCloseOnLock"] = "鎖上自動關門",
    ["Settings.Sections.Misc.DoorCloseOnLock.Description"] = "TARDIS 應該在鎖定時自動關門嗎？",
    ...
    ["Settings.Sections.Misc.EnableIsomorphicSecurityDefault"] = "預設啟用同構安全",
    ["Settings.Sections.Misc.EnableIsomorphicSecurityDefault.Description"] = "預設其他人是否可以操作你的塔迪斯",
    ["Settings.Sections.Misc.Events"] = "活動",
    ["Settings.Sections.Misc.Events.Description"] = "是否啟用各種季節性活動",
    ["Settings.Sections.Misc.Events.SkipCurrent"] = "跳過當前事件",
    ["Settings.Sections.Misc.Events.SkipCurrent.Description"] = "如果當前有進行中的季節性活動，則跳過。",
    ...
    ["Settings.Sections.Misc.Flight.FlightInterruptToFloat"] = "飛行中斷後啟用反重力",
    ["Settings.Sections.Misc.Flight.FlightInterruptToFloat.Description"] = "當飛行模式被手剎或低 artron 能量中斷時，是否應該自動啟用反重力？",
    ...
    ["Settings.Sections.Misc.Spawning.LegacyDoorType"] = "使用傳統門類型生成",
    ["Settings.Sections.Misc.Spawning.LegacyDoorType.Description"] = "TARDIS 門會在點擊時將玩家傳送到裡面（而不是打開）",
    ["Settings.Sections.Misc.Spawning.NoInterior"] = "沒有內飾",
    ["Settings.Sections.Misc.Spawning.NoInterior.Description"] = "啟用後，TARDIS 將在沒有內部的情況下生成",
    ...
    ["Settings.Sections.Misc.Spawnmenu"] = "生成選單",
    ...
    ["Settings.Sections.Misc.Teleport.InfiniteWarning"] = "無限傳送警告",
    ["Settings.Sections.Misc.Teleport.InfiniteWarning.Description"] = "啟用後，TARDIS 會持續提醒你 demat/mat 失敗，直到你解決問題為止",
    ...
    ["Settings.Sections.Performance.ExtraLights"] = "內部額外的燈",
    ["Settings.Sections.Performance.ExtraLights.Description"] = "每個室內有一個以上的光源",
    ["Settings.Sections.Performance.GUIAnimations"] = "啟用 GUI 動畫",
    ["Settings.Sections.Performance.GUIAnimations.Description"] = "UI的元素是否應該有動畫",
    ["Settings.Sections.Performance.Lamps"] = "室內燈",
    ["Settings.Sections.Performance.Lamps.Description"] = "啟用額外的車內燈",
    ...
    ["Settings.Sections.SoundsAndMusic.Sounds.InteriorHumLeakage"] = "內部嗡嗡聲洩漏",
    ["Settings.Sections.SoundsAndMusic.Sounds.InteriorHumLeakage.Description"] = "當門打開時，是否可以從外部聽到內部嗡嗡聲",
    ["Settings.Sections.SoundsAndMusic.Sounds.InteriorHumLeakageVolume"] = "內部嗡嗡聲洩漏音量",
    ["Settings.Sections.SoundsAndMusic.Sounds.InteriorHumLeakageVolume.Description"] = "當門打開時，洩漏到外部的內部嗡嗡聲的音量",
    ["Settings.Sections.SoundsAndMusic.Sounds.Lock"] = "鎖定音效",
    ["Settings.Sections.SoundsAndMusic.Sounds.Lock.Description"] = "開關鎖時是否發出聲音",
    ["Settings.Sections.SoundsAndMusic.Sounds.SpawnDelete"] = "生成/刪除聲音",
    ["Settings.Sections.SoundsAndMusic.Sounds.SpawnDelete.Description"] = "生成/刪除 TARDIS 時是否發出聲音",
    ...
    ["Settings.Sections.UI"] = "使用者介面",
    ["Settings.Sections.UI.Icons"] = "圖示",
    ["Settings.Sections.UI.Icons.IconPack.Customize"] = "自訂圖示",
    ["Settings.Sections.UI.Icons.IconPack.Customize.Description"] = "設定啟用哪些圖示包及其順序，另有生成選單圖示模式",
    ["Settings.Sections.UI.Icons.SpawnmenuIconMode"] = "生成選單圖示模式",
    ["Settings.Sections.UI.Icons.SpawnmenuIconMode.Description"] = "預設和滑鼠懸停時生成選單圖示顯示的內容",
    ["Settings.Sections.UI.Language"] = "語",
    ["Settings.Sections.UI.Language.Default"] = "遊戲語言",
    ["Settings.Sections.UI.Language.Description"] = "插件的語言，對於任何缺失的翻譯回退到英語",
    ["Settings.Sections.UI.NotificationType"] = "通知類型",
    ["Settings.Sections.UI.NotificationType.Description"] = "正在使用的通知類型",
    ["Settings.Sections.UI.NotificationType.Types.Chat"] = "聊天通知",
    ["Settings.Sections.UI.NotificationType.Types.ConsoleLog"] = "操縱臺日誌",
    ["Settings.Sections.UI.NotificationType.Types.Disabled"] = "禁用",
    ["Settings.Sections.UI.NotificationType.Types.Inbuilt"] = "內置通知",
    ["Settings.Sections.UI.Screen"] = "螢幕",
    ["Settings.Sections.UI.Screen.Chameleon3DPreview"] = "變色龍電路 3D 預覽（實驗性）",
    ["Settings.Sections.UI.Screen.Chameleon3DPreview.Description"] = "在變色龍電路畫面啟用所選外觀的 3D 可移動預覽",
    ["Settings.Sections.UI.Screen.OldGUI"] = "使用舊螢幕",
    ["Settings.Sections.UI.Screen.OldGUI.Description"] = "使用沒有圖片的舊版2D螢幕而不是新的那一個",
    ["Settings.Sections.UI.Screen.PopupRows"] = "螢幕列數（彈出視窗）",
    ["Settings.Sections.UI.Screen.PopupRows.Description"] = "彈出視窗應該有多少排按鈕？",
    ["Settings.Sections.UI.Screen.PopupScale"] = "螢幕彈出視窗縮放",
    ["Settings.Sections.UI.Screen.PopupScale.Description"] = "允許調整彈出視窗的大小",
    ["Settings.Sections.UI.Screen.ScreenOverrideRows"] = "覆寫螢幕列數 (3D)",
    ["Settings.Sections.UI.Screen.ScreenOverrideRows.Description"] = "是否覆蓋按鈕行的內部設置",
    ["Settings.Sections.UI.Screen.ScreenRows"] = "螢幕列數 (3D)",
    ["Settings.Sections.UI.Screen.ScreenRows.Description"] = "3D螢幕應該有多少排按鈕？",
    ["Settings.Sections.UI.Screen.Theme"] = "螢幕主題",
    ["Settings.Sections.UI.Screen.Theme.Description"] = "用戶界面的主題",
    ["Settings.Sections.UI.ShowReleaseNotes"] = "顯示發行說明",
    ["Settings.Sections.UI.ShowReleaseNotes.Description"] = "TARDIS 更新時是否應顯示發行說明？",
    ["Settings.Sections.UI.Tips"] = "提示",
    ["Settings.Sections.UI.Tips.Enabled"] = "提示",
    ["Settings.Sections.UI.Tips.Enabled.Description"] = "塔迪斯操縱臺上是否顯示提示",
    ["Settings.Sections.UI.Tips.ShowAll"] = "始終顯示所有提示",
    ["Settings.Sections.UI.Tips.ShowAll.Description"] = "是否應該為 TARDIS 控件顯示所有提示？",
    ["Settings.Sections.UI.Tips.Style"] = "提示風格",
    ["Settings.Sections.UI.Tips.Style.Description"] = "塔迪斯提示所使用的風格",
    ["Spawnmenu.AlternativeVersions"] = "選擇版本：",
    ["Spawnmenu.Category"] = "神秘博士 - 塔迪斯",
    ["Spawnmenu.CategoryTools"] = "神秘博士 - TARDIS 工具",
    ["Spawnmenu.Chameleon"] = "變色龍電路",
    ["Spawnmenu.Chameleon.Enable"] = "生成時啟用",
    ["Spawnmenu.ClassicDoorsVersion"] = "經典門版本：",
    ["Spawnmenu.CopyID"] = "複製 ID",
    ...
    ["Spawnmenu.ReloadRequired"] = "需要重新加載",
    ...
    ["Update.NeverShow"] = "不再顯示更新",
    ["Update.ShowReleaseNotes"] = "想了解更多嗎？",
    ["Update.Updated"] = "塔迪斯已更新至版本 %s",
