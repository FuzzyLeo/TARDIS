...
T.Phrases = {
    ...
    ["Controls.ToggleConsole.Tip"] = "控制台開關",
    ...
    ["Interiors.Default.CustomSettings.ExteriorTextures.AlternativeCapaldi"] = "另類（Capaldi）",
    ["Interiors.Default.CustomSettings.ExteriorTextures.AlternativeSmith"] = "替代方案（Smith）",
    ["Interiors.Default.CustomSettings.ExteriorTextures.Default"] = "預設",
