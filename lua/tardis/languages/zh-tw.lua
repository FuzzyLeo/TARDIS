...
T.Phrases = {
    ...
    ["Events.NotifyEvent"] = "「%s」事件目前正在進行中，請前往 TARDIS -> %s 設定以跳過或更改。",
    ...
    ["Settings.Sections.Exterior.Rendering.EnhancedFadingEnabled"] = "增強淡入淡出效果（實驗性）",
    ["Settings.Sections.Exterior.Rendering.EnhancedFadingEnabled.Description"] = "警告：此為實驗性功能，透過外部觀看其他實體或道具時可能導致渲染問題。\n\n修復外部淡入或淡出時的渲染問題（背面剔除）",
